...
sakra_knowledge = {
    "company": (
        "SAKRA VISION is an AI product studio founded by Likith Naidu Anumakonda. "
        "We build AI applications, computer vision systems, LLM/RAG tools, automation systems, "
        "civic-tech platforms, event automation tools, and full-stack intelligent products."
    ),
    "founder": (
        "SAKRA VISION was founded by Likith Naidu Anumakonda. He is an AI/ML Engineer, "
