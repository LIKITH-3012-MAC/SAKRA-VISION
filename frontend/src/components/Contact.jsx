...
const Contact = () => {
  ...
  return (
    <section id="contact" className="relative py-24 px-6 max-w-6xl mx-auto bg-black text-left">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 max-w-5xl mx-auto relative z-10">
        ...
        <motion.div
          ...
          viewport={{ once: true }}
          transition={{ duration: 0.6 }}
          className="lg:col-span-7 apple-glass p-8 rounded-3xl relative shadow-2xl min-h-[450px]"
        >
          <AnimatePresence mode="wait">
            {submitStatus === 'success' ? (
              <motion.div
                ...
                className="py-12 px-4 text-center flex flex-col items-center justify-center min-h-[400px] w-full"
              >
                <div className="w-16 h-16 rounded-full bg-blue-500/10 border border-blue-500/30 flex items-center justify-center text-[#38bdf8] mb-6 blue-rim mx-auto">
